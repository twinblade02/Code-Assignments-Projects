...
class DriftAnalysis:
    ...
    def load_baseline(self, experiment_name="drift-detection"):
        ...
        try:
            ...
            self.preprocessed_baseline = self.preprocess_for_model(self.baseline_data)
    ...
    def preprocess_for_model(self, raw_data):
        ...
        try:
            ...
            if hasattr(self.baseline_model, 'named_steps'):
                ...
                print(f"Data preprocessed: {raw_data.shape} -> {transformed_df.shape}")
            
                return transformed_df
            else:
                print("Model is not a pipeline - returning raw data")
                return raw_data
    ...
    def create_drift_simulation(self, strength=0.5):
        ...
        #preprocessed_drift_data = self.preprocess_for_model(drift_data)
